<%-- 
    Document   : mostrarempleadocedula
    Created on : 22-jul-2018, 22:40:25
    Author     : Angel-Pc
--%>
        ...
        %>
            <table border="1">               
                ...
                <tr>
                    <td>Apellido:</td>
                    <td>
                        <input type="text" name="txtApellido" value="<%=apellido%>" required="required" placeholder="Apellidos" readonly=”readonly”/>
                    </td>
                </tr>
                ...
                <tr>
                    <td>Tipo:</td>
                    <td>
                        <input type="text" name="txtTipo" value="<%=tipo%>" required="required" placeholder="Tipo" readonly=”readonly”/>
                    </td>
                </tr>
                <tr>
                    <td>Celular:</td>
                    <td>
                        <input type="text" name="txtCelular" value="<%=celular%>" required="required" placeholder="9999999999" readonly=”readonly”/>
                    </td>
                </tr>
                <tr>
                    <td>Email:</td>
                    <td>
                        <input type="text" name="txtMail" value="<%=mail%>" required="required" placeholder="ejemplo@yahoo.com" readonly=”readonly”/>
                    </td>
                </tr>
                <tr>
                    <td>Observación:</td>
                    <td>
                        <textarea name="txtObservacion" rows="3" cols="30" readonly=”readonly”><%=observacion%>
                        </textarea>
                    </td>
                </tr>
                <tr>
                    <th colspan="2">
                        <input type="button" value="Editar" name="btnEditar" onclick="location.href = 'formularioeditarempleado.jsp?ci=<%=empleado.getCedula()%>'"/>
                        <input type="button" value="Eliminar" name="btnElimnar" onclick="location.href = 'formularioeliminarempleado.jsp?ci=<%=empleado.getCedula()%>'"/>
